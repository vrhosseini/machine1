...
def LossPDE(Collo_x,Collo_y, n1=0, n2=0):
    ...
    return loss_f_s11r, loss_f_s22r, loss_f_s12r,lossf_x,lossf_y,loss_u
    ...
    for epoch in range(epochs):
      #for batch_idx, (x, t) in enumerate(dataloader):
            def closure():
                ...
                loss_f_s11r, loss_f_s22r, loss_f_s12r,lossf_x,lossf_y,loss_u  = LossPDE(Collo_x,Collo_y, nx_Neum, ny_Neum)
